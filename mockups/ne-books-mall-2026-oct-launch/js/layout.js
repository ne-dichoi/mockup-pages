...
(function(){
    ...
    <div class="container">
      ...
      <div class="gnb">
        ...
        <div class="gnb-drop" id="gnbDrop">
          ...
          <div class="gd-promo">
            <a href="#"><span class="gd-promo-img" style="background-image:url('assets/banner_books.png')"></span></a>
  ...
  function openFor(a){
    ...
    var BR='<div class="gd-promo"><a href="#"><span class="gd-promo-img" style="background-image:url(\'assets/banner_books.png\')"></span></a><div class="gd-promo-tit">신간 출시, 지금 만나보세요</div><div class="gd-promo-desc">새롭게 출간된 교재를 가장 먼저 확인하세요 &#8250;</div></div>';
    if(mega){
